    ...
    return (
      <div className="pv2-root" style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh" }}>
        <div style={{ textAlign: "center", color: "var(--pv2-muted)" }}>
          ...
          <button className="pv2-back-btn" style={{ background: "var(--pv2-surface)", color: "var(--pv2-ink2)", border: "1px solid var(--pv2-border)" }} onClick={() => navigate(`/profiles/${profile_id}`)}>
            ← Back to Profile
          </button>
        </div>
      </div>
