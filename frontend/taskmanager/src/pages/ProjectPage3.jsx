...
/* ─── Task Modal ─────────────────────────────────────────────────────────── */
function TaskModal({ mode, task, projectId, members, onClose, onSaved, onDeleted }) {
  ...
  return (
    <div className="pv2-modal-backdrop" onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className={`pv2-modal ${isDel ? "pv2-modal-sm" : ""}`}>
    ...
    <div className="pv2-task-card">
      ...
      <div className="pv2-task-card-actions">
        ...
        <button
                ...
                >
                  {completing ? "…" : isDone ? "✅ Done" : "✓ Complete"}
                </button>
...
export default function ProjectView() {
  ...
  return (
    ...
    .pv2-task-action-complete {
      color: #059669;
    }
    .pv2-task-action-complete:hover:not(:disabled) {
      background: #ecfdf5;
      border-color: #6ee7b7;
      color: #047857;
    }
    .pv2-task-action-complete:disabled {
      opacity: 0.5;
      cursor: not-allowed;
    }
      `}</style>
